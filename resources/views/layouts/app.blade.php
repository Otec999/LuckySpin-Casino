    ...
    <div class="overlayed">
        ...
        <div class="popup popup--crash-info">
            ...
            <div class="popup__content">
                ...
                <div class="text__borders"></div>
                <p> 
                    Сервис LuckySpin Casino не гарантирует своевременного выполнения ручного вывода после нажатия (кнопка "Вывести деньги") и настоятельно рекомендует использовать функцию автоматического вывода средств (поле "Автовывод").
                </p>
                <div class="text__borders"></div>
                <p>
