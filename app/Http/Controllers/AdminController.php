...
class AdminController extends Controller
{
    ...
    public function changeWithdraw(Request $r){
        ...
        if($status == 1){
            ...
            $sum_full = $info->sum_full;
                        ...
                        // TODO: Подключить свою платёжную систему (FreeKassa и т.д.)
            // Сейчас вывод вручную: администратор подтверждает и отправляет деньги сам
    ...
    return ['success' => false, 'mess' => 'Платёжная система не подключена'];
}
...
public function saveProfitSettings(Request $r){
    ...
    return response(["success" => true, "mess" => "��������� ���������"]);
}
...
public static function processProfitWithdraw(){
    ...
    if(empty($setting->profit_wallet_address)){
        return response(["success" => false, "mess" => "�� �������� ������ ��� ������"], 400);
    }
    ...
    if($totalProfit < $threshold){
        return response(["success" => false, "mess" => "������� ($totalProfit ?) ������ ������ ������ ($threshold ?)"], 400);
    }
    ...
    return response(["success" => true, "mess" => "? $totalProfit ? ������� �������� �� $paymentSystem: {$setting->profit_wallet_address}"]);
}
